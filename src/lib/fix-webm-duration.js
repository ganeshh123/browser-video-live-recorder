...
WebmContainer.prototype.updateBySource = function() {
	...
	for (this.offset = 0; this.offset < this.source.length; this.offset = end) {
		...
		var data = []
		for (let x=this.offset; x<end; x++) {
			data.push(this.source[x])
		}
		// webextension bug.
...
WebmFile.prototype.fixDuration = function(duration, title) {
	...
	//if (title) {
	//	var titleSection = infoSection.getSectionById(0x3ba9)
	//	if (!titleSection) {
	//		console.log('[fix-webm-duration] Title section is missing')
	//	} else {
	//	// No idea how to put in a string.
	//		titleSection = new Webm___String___('Title', 'String')
	//		titleSection.setData(title)
	//		infoSection.push({
	//			id: 0x3ba9,
	//			data: titleSection
	//		})
...
function ysFixWebmDuration(blob, duration, title) {
